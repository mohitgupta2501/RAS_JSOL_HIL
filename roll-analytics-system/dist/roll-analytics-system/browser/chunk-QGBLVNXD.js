...
var NavbarComponent = class _NavbarComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NavbarComponent, selectors: [["app-navbar"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 36, vars: 5, consts: [[1, "navbar"], [1, "navbar-left"], ["aria-label", "Toggle menu", 1, "mobile-menu-btn", 3, "click"], [1, "material-icons"], ["href", "#", 1, "logo-box", "client-box"], [1, "logo-icon", "client-icon"], [1, "logo-text"], [1, "navbar-center"], [1, "material-icons", "title-icon"], [1, "app-title"], [1, "navbar-right"], [1, "shift-card"], [1, "shift-badge"], [1, "shift-text"], [1, "shift-label"], [1, "shift-time"], [1, "navbar-divider"], ["aria-label", "Notifications", 1, "icon-btn", "notification-btn", 3, "routerLink"], ["class", "badge", 4, "ngIf"], ["title", "AD", 1, "avatar"], ["href", "#", 1, "logo-box", "hitachi-box"], [1, "logo-icon", "hitachi-icon"], [1, "badge"]], template: function NavbarComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(13, "Roll Analytics System");
        \u0275\u0275elementEnd()();
        ...
        \u0275\u0275elementEnd()()();
        \u0275\u0275element(23, "div", 16);
        \u0275\u0275elementStart(24, "a", 17)(25, "span", 3);
        \u0275\u0275text(26, "notifications");
        \u0275\u0275elementEnd();
        \u0275\u0275template(27, NavbarComponent_span_27_Template, 1, 0, "span", 18);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(28, "div", 19)(29, "span");
        \u0275\u0275text(30, "AD");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(31, "a", 20)(32, "span", 21);
        \u0275\u0275text(33, "H");
        \u0275\u0275elementEnd();
...
function SidebarComponent_a_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(1, "span", 13)(2, "span", 14);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
...
function SidebarComponent_footer_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "footer", 16)(1, "div", 17);
    \u0275\u0275element(2, "span", 18);
...
function FooterComponent_span_49_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 27);
  }
}
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FooterComponent, selectors: [["app-footer"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 55, vars: 12, consts: [["class", "popup-backdrop", 3, "click", 4, "ngIf"], [1, "alarm-popup"], [1, "popup-header"], [1, "popup-title"], [1, "material-icons"], [1, "total-badge"], [1, "popup-chips"], [1, "chip", "high"], [1, "chip", "medium"], [1, "chip", "low"], [1, "close-popup", 3, "click"], [1, "popup-table-wrap"], [1, "popup-table"], [4, "ngFor", "ngForOf"], [1, "popup-footer-bar"], ["routerLink", "/alarms", 1, "view-all-btn", 3, "click"], [1, "alarm-footer-bar", 3, "click"], [1, "footer-left"], [1, "material-icons", "footer-alarm-icon"], ["class", "alarm-live-dot", 4, "ngIf"], [1, "footer-right"], [1, "footer-clock"], [1, "material-icons", "expand-icon"], [1, "popup-backdrop", 3, "click"], [1, "material-icons", "cal-icon"], [1, "param-chip"], [1, "severity-badge"], [1, "alarm-live-dot"]], template: function FooterComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(9);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(10, "div", 6)(11, "span", 7)(12, "span", 4);
        \u0275\u0275text(13, "error");
        \u0275\u0275elementEnd();
        \u0275\u0275text(14);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(15, "span", 8)(16, "span", 4);
        \u0275\u0275text(17, "warning");
        \u0275\u0275elementEnd();
        \u0275\u0275text(18);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(19, "span", 9)(20, "span", 4);
        ...
        \u0275\u0275template(39, FooterComponent_tr_39_Template, 13, 6, "tr", 13);
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(40, "div", 14)(41, "button", 15);
        ...
        \u0275\u0275text(48, "alarm");
        \u0275\u0275elementEnd();
        \u0275\u0275template(49, FooterComponent_span_49_Template, 1, 0, "span", 19);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(50, "div", 20)(51, "span", 21);
        \u0275\u0275text(52);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(53, "span", 22);
        \u0275\u0275text(54, "expand_less");
        \u0275\u0275elementEnd()()();
      }
      if (rf & 2) {
...
var LayoutComponent = class _LayoutComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LayoutComponent, selectors: [["app-layout"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 6, vars: 2, consts: [[1, "layout-body"], [1, "main-content"]], template: function LayoutComponent_Template(rf, ctx) {
      if (rf & 1) {
...
//# sourceMappingURL=chunk-QGBLVNXD.js.map
